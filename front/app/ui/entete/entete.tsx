...
export function Entete() {
    return <header className="bg-white dark:bg-gray-900">
        <nav className="bg-gradient-to-r from-orange-700 to-orange-100 pt-1">
            <div className="container flex items-center justify-between px-6 py-3 mx-auto w-full bg-white">
